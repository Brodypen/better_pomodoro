    ...
    <div className="fixed z-50 w-full h-16 max-w-lg -translate-x-1/2 bg-white border border-gray-200 rounded-full bottom-4 left-1/2 dark:bg-gray-700 dark:border-gray-600">
      <div className="grid h-full max-w-lg grid-cols-4 mx-auto">
        ...
        >
          ...
          <span className="whitespace-nowrap opacity-80">Home</span>
        </Link>
        ...
        >
          ...
          <span className="opacity-80 whitespace-nowrap">Stats</span>
        </button>
        <button
        ...
        >
          ...
          <span className="opacity-80 whitespace-nowrap">Profile</span>
        </button>
        <div
          id="tooltip-profile"
          role="tooltip"
